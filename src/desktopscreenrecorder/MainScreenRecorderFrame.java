...
//        initObjects();
    ...
    private void initComponents() {
        ...
        buttonStartRecording.setText("Начать запись");
        ...
        buttonStopRecording.setText("Остановить запись");
        ...
        jCheckBox1.setText("5с задержка");

        jLabel2.setText("Состояние : ");

        recordStateLabel.setText("Запись не начата");

        jLabel4.setText("Время записи : ");

        recordTimeLabel.setText("0 мин");

        jLabel6.setText("Продолжительность");
